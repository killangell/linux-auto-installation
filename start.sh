...
SRC_DIR=$SYSTEM_DIR:$LIBRARY_DIR:$LIBRARY_DIR_COMMON:$MODULES_DIR:$RUNNING_DIR:$RUNNING_MODULES_DIR:$TOOLS_DIR:$TOOLS_KICKSTART_DIR:$TOOLS_KICKSTART_PARTITION_DIR:$TOOLS_INSMOD_DIR
...
UNIT_TEST_DIR_ALL=$UINT_TEST_SYSTEM_DIR:$UINT_TEST_LIBRARY_DIR:$UINT_TEST_LIBRARY_DIR_COMMON:$UINT_TEST_PROCESS_DIR:$UINT_TEST_MODULES_DIR:$UINT_TEST_RUNNING_DIR:$UINT_TEST_TOOLS_DIR:$UINT_TEST_TOOLS_KICKSTART_DIR:$UINT_TEST_TOOLS_KICKSTART_PARTITION_DIR
